...
class HomeScreen extends StatelessWidget {
  ...
  final List<String> author = ["Tana French", "Dan Brown", "Daphne du Maurier", "Dan Brown", "Gillian Flynn"];
  final List<String> title = ["In The Woods", "The Da Vinci Code", "Rebecca", "Angels & Demons", "Dark Places"];
  final List<String> rating = ["4", "5", "3.5", "5", "4.5"];
  final List<int> pages = [385, 405, 415, 325, 400];
  final String storyLine = "StorylineStorylineStorylineStorylineStorylineStorylineStorylineStorylineStorylineStorylineStoryline";
  final List<String> imgPath = [
    "assets/images/inthewoods.jpg",
    "assets/images/davincicode.jpg",
    "assets/images/rebecca.jpg",
    "assets/images/angelsandemons.jpg",
    "assets/images/darkplaces.jpg"
  ];
    ...
    return Scaffold(
      ...
      drawer: Theme(
        data: Theme.of(context).copyWith(
          canvasColor:
              Colors.black87, //s will change the drawer background to blue.
          //other styles
        ),
        child: Drawer(
          child: ListView(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    return Padding(
                      ...
                      child: BookTemplate(book: bookList[index]),
                    );
                  },
                ),
              ),
            ...
            //                 child: Image(
            //                   image:
            //                       AssetImage('assets/images/davincicode.jpg'),
            //                   fit: BoxFit.cover,
            //                   height: 100,
            //                 ),
            //               ),
            ...
            //             Navigator.push(
            //               context,
            //               MaterialPageRoute(builder: (context) => MM2()),
            //             );
            //           },
            //           //child:
            //         ),
            ...
            //             Navigator.push(
            //               context,
            //               MaterialPageRoute(builder: (context) => MM3()),
            //             );
            //           },
            //           //child:
            //         ),
            ...
            //             Navigator.push(
            //               context,
            //               MaterialPageRoute(builder: (context) => MM4()),
            //             );
            //           },
            //           //child:
            //         ),
            ...
            //             Navigator.push(
            //               context,
            //               MaterialPageRoute(builder: (context) => MM5()),
            //             );
            //           },
            //           //child:
            //         ),
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rom1()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image(
                              image:
                                  AssetImage('assets/images/mebeforeyou.jpg'),
                              fit: BoxFit.cover,
                              height: 100,
                            ),
                          ),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rom2()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rom3()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rom4()),
                        );
                      },
                      //child:
                    ),
                      ...
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image(
                              image: AssetImage(
                                  'assets/images/theweddingdate.jpg'),
                              fit: BoxFit.cover,
                              height: 100,
                            ),
                          ),
                          Padding(padding: EdgeInsets.all(5.0)),
                          Text('The Wedding Date',
                              style: TextStyle(color: Colors.white)),
                        ],
                      ),
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rom5()),
                        );
                      },
                      //child:
                    ),
                  ...
                  children: <Widget>[
                      ...
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image(
                              image:
                                  AssetImage('assets/images/coldcomfort.jpg'),
                              fit: BoxFit.cover,
                              height: 100,
                            ),
                          ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => C4()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => C5()),
                        );
                      },
                      //child:
                    ),
                  ...
                  children: <Widget>[
                      ...
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image(
                              image:
                                  AssetImage('assets/images/panchatantra.jpg'),
                              fit: BoxFit.cover,
                              height: 100,
                            ),
                          ),
                    ...
                    GestureDetector(
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            ...
                            child: Image(
                              image:
                                  AssetImage('assets/images/jatakatales.jpg'),
                              fit: BoxFit.cover,
                              height: 100,
                            ),
                          ),
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Jataka()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Madeline()),
                        );
                      },
                      //child:
                    ),
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Wonder()),
                        );
                      },
                      //child:
                    ),
